...
export default function AboutSanstha() {
  return (
    <div className="bg-pink-30 min-h-screen text-black-800 pb-10">
      ...
      <div><div className="text-center py-8">
        ...
        <div className="mt-2 flex justify-center items-center gap-6 text-sm text-red-700">
           <div class="w-50 h-px bg-red-700"></div>
           <div class="mx-6 text-red-700 text-3xl">★</div>
           <div class="w-50 h-px bg-red-700"></div></div>
           <span>🏠</span>
          <span>››</span>
          <span className="underline">about sanstha</span>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto space-y- px-8">
        <details className="border border-black rounded-d p-4 bg-white">
        ...
        <details className="border border-black rounded-d p-4 bg-white font-roboto">
          <summary className="font-bold cursor-pointer">
    ...
    <ul className="list-[lower-alpha] list-inside space-y-1">
